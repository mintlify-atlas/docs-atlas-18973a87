---
title: "Get Started with advanced-mark.js in Minutes"
sidebarTitle: "Quickstart"
description: "Install advanced-mark.js, create your first Mark instance, highlight text in the DOM, and style your results in just a few steps."
---
...
<Steps>
  ...
  <Step title="Call mark() to highlight text">
    ...
    instance.mark('lorem ipsum', {
      ...
      done: (count) => console.log(`Marked ${count} matches`),
    });
    ```
...
The `separateWordSearch: true` option splits the string `'lorem ipsum'` into individual words and highlights each one independently. The `done` callback receives the total number of mark elements created.
