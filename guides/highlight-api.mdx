...
description: "Use the highlight option to leverage the native browser CSS Custom Highlight API, styling text ranges without DOM wrapping for significantly faster highlighting."
---
