...
description: "Use shadowDOM and iframes options to traverse open shadow roots and same-origin iframes, injecting highlights and custom styles into each scope."
---
